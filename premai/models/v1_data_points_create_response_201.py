...
T = TypeVar("T", bound="V1DataPointsCreateResponse201")


class V1DataPointsCreateResponse201Dict(TypedDict):
    id: int
    positive: bool
    project: int
...
@_attrs_define
class V1DataPointsCreateResponse201:
    """
    Attributes:
        id (int):
        positive (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_data_points_create_response_201 = cls(
            id=id,
            positive=positive,
            project=project,
            input_=input_,
        ...
        v1_data_points_create_response_201.additional_properties = d
        return v1_data_points_create_response_201
