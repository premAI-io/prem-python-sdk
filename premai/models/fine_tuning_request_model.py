...
T = TypeVar("T", bound="FineTuningRequestModel")


class FineTuningRequestModelDict(TypedDict):
    id: int
    slug: str
    alias: NotRequired[Union[None, Unset, str]]
    group: NotRequired[Union[None, Unset, str]]
    model_provider: NotRequired[Union[BlankEnum, ModelProviderEnum, None, Unset]]
    pass


@_attrs_define
class FineTuningRequestModel:
    """
    Attributes:
        id (int):
        slug (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        fine_tuning_request_model.additional_properties = d
        return fine_tuning_request_model
