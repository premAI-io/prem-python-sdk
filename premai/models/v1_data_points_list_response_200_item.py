...
T = TypeVar("T", bound="V1DataPointsListResponse200Item")


class V1DataPointsListResponse200ItemDict(TypedDict):
    id: int
...
@_attrs_define
class V1DataPointsListResponse200Item:
    """
    Attributes:
        id (int):
        created_at (datetime.datetime):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_data_points_list_response_200_item = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            positive=positive,
        ...
        v1_data_points_list_response_200_item.additional_properties = d
        return v1_data_points_list_response_200_item
