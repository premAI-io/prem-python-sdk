...
T = TypeVar("T", bound="V1DataPointsCreateJsonBody")


class V1DataPointsCreateJsonBodyDict(TypedDict):
    id: int
    positive: bool
    project: int
...
@_attrs_define
class V1DataPointsCreateJsonBody:
    """
    Attributes:
        id (int):
        positive (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_data_points_create_json_body = cls(
            id=id,
            positive=positive,
            project=project,
            input_=input_,
        ...
        v1_data_points_create_json_body.additional_properties = d
        return v1_data_points_create_json_body
