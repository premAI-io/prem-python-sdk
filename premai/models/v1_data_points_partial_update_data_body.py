...
T = TypeVar("T", bound="V1DataPointsPartialUpdateDataBody")


class V1DataPointsPartialUpdateDataBodyDict(TypedDict):
...
@_attrs_define
class V1DataPointsPartialUpdateDataBody:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_data_points_partial_update_data_body = cls(
            id=id,
        ...
        v1_data_points_partial_update_data_body.additional_properties = d
        return v1_data_points_partial_update_data_body
