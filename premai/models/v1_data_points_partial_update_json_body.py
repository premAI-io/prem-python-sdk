...
T = TypeVar("T", bound="V1DataPointsPartialUpdateJsonBody")


class V1DataPointsPartialUpdateJsonBodyDict(TypedDict):
...
@_attrs_define
class V1DataPointsPartialUpdateJsonBody:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_data_points_partial_update_json_body = cls(
            id=id,
        ...
        v1_data_points_partial_update_json_body.additional_properties = d
        return v1_data_points_partial_update_json_body
