...
T = TypeVar("T", bound="V1DataPointsRetrieveResponse200")


class V1DataPointsRetrieveResponse200Dict(TypedDict):
    id: int
...
@_attrs_define
class V1DataPointsRetrieveResponse200:
    """
    Attributes:
        id (int):
        created_at (datetime.datetime):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        v1_data_points_retrieve_response_200 = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            positive=positive,
        ...
        v1_data_points_retrieve_response_200.additional_properties = d
        return v1_data_points_retrieve_response_200
