...
T = TypeVar("T", bound="FineTuningJobDetailsRequest")


class FineTuningJobDetailsRequestDict(TypedDict):
    project_id: int
...
@_attrs_define
class FineTuningJobDetailsRequest:
    """
    Attributes:
        project_id (int):
        fine_tuning_job_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        fine_tuning_job_details_request = cls(
            project_id=project_id,
            fine_tuning_job_id=fine_tuning_job_id,
        )

        fine_tuning_job_details_request.additional_properties = d
        return fine_tuning_job_details_request
